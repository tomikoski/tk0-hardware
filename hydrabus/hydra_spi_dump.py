...
def hydrabus_setup():
    ...
    #Open serial port, select ACM0 for Linux, .usbmodemXXXX for macOS
    #hydrabus = serial.Serial('/dev/ttyACM0', 115200)
    hydrabus = serial.Serial('/dev/tty.usbmodem2101', 115200)
    ...
    #hydrabus.write(b'\x81') # 1 = 0x81 = SPI1

    # Configure SPI port (default polarity and clock phase, SPI2 device)
    # SPI2 = 0, https://github.com/hydrabus/hydrafw/wiki/HydraFW-Binary-SPI-mode-guide
    hydrabus.write(b'\x80') # 0 = 0x80 = SPI2
