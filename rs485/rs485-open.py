...
try:
  s = serial.Serial(port='/dev/ttyUSB0',baudrate=9600, timeout=3.0)
  s.write(bytes.fromhex("8a0101119b"))
  sleep(2)
  s.write(bytes.fromhex("8a01021198"))
  sleep(2)
  s.write(bytes.fromhex("8a01031199"))
  sleep(4)
  #s.write(bytes.fromhex("8A 01 12 11 88"))
  #open all
  s.write(bytes.fromhex("8A0100119a"))
except:
  print("error!")
